...
//readymade calender component here antd stands for ant design which is React UI library
...
const Search = () => {
  ...
  function searchHandler(e){
    ...
    setValue([])//sets value to default after the search
  }
  ...
  return (
    ...
    <div className='searchbar'>
     ...
     <span className='material-symbols-outlined searchicon' onClick={searchHandler}>search
      </span>

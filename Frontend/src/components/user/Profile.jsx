                ...
                <div className='col-6 col-md-6 profile object-fit-cover'>
                    ...
                    <div className='userinfo'>
                        ...
                        <div className='buttons'>
                            <Link to="/editprofile" id='edit_profile' className='btn btn-block my-5'>Edit Profile
                            </Link>
                            <Link to="/user/updatepassword" className='btn btn-block my-5 mx-4'>Change Password
                            </Link>
                        </div>
